\documentclass[spanish,a4paper]{article} \usepackage[spanish]{babel}
\usepackage[utf8]{inputenc} \author{Luis A. Guanuco} \title{Practica
  Profesional Supervisada} \date{Marzo 2012}
\begin{document}
\maketitle
